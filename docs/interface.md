...
When Vim starts without a file, SISUVim opens a Dashboard and a 30-column
...
- `:Lexplore 30` — open the native tree sidebar explicitly.

The interface adds a persistent statusline, a tabline, true-colour support
where available, and a restrained deep-blue colour palette. Set
